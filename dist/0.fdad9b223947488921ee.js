...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    result() {
      if (!this.num) return "Введите id - цифру";
      this.$store.dispatch('fetch', 'https://jsonplaceholder.typicode.com/users/' + this.num).then(json => json);
    },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("input", { attrs: { num: _vm.num, type: "text" } }),
      _vm._v(" "),
...
//# sourceMappingURL=0.fdad9b223947488921ee.js.map