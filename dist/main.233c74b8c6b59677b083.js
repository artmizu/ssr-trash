...
/******/ 		return __webpack_require__.p + "" + ({}[chunkId]||chunkId) + "." + {"0":"a2ec2fe39202f7b8a1c5"}[chunkId] + ".js"
/******/ 	}
/******/
...
var render = function() {
  ...
  return _c(
    "div",
    { attrs: { id: "app" } },
    [_c("h1", [_vm._v("Se title")]), _vm._v(" "), _c("router-view")],
    1
  )
}
var staticRenderFns = []
...
function createRouter() {
  return new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
    ...
    routes: [{
      path: '/',
      component: () => __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ./components/Item.vue */ "./src/components/Item.vue"))
    }]
  });
}
  ...
  return new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
    ...
    actions: {
      fetch({
        ...
        return node_fetch__WEBPACK_IMPORTED_MODULE_2___default()('https://jsonplaceholder.typicode.com/users').then(response => response.json());
      },

      fetchItem({
        commit
      }) {
        return node_fetch__WEBPACK_IMPORTED_MODULE_2___default()('https://jsonplaceholder.typicode.com/users').then(response => response.json()).then(json => commit('setItems', json));
      }

    },
    mutations: {
      setItems(state, items) {
        vue__WEBPACK_IMPORTED_MODULE_0__["default"].set(state, 'items', items);
      }
...
/******/ });
//# sourceMappingURL=main.233c74b8c6b59677b083.js.map